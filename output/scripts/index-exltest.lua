...
local function main()
	...
	local listdefstring = require('list.defstring')
	...
	local translate = require('exl.il.translate')
	...
	rsutil.saveptype(listptype, block.trace, 'testr.exlb')
	-- print(block:defstring(''))
	print(translate(block.trace))
end
