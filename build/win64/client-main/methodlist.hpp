...
struct methodlist_t
{
	...
	bool(*window_window_setshape)(::window::Window* self, ::graphics::Shape* nv) NOEXCEPT;
	bool(*window_window_popevent)(::window::Window* self, ::window::Event* event, bool* result) NOEXCEPT;
};
